...
?>">
	...
	<div class="catItemHeader">
		...
		<!-- Date created -->
		<!-- edited -->
		<div style="margin-top: 15px;"><b><span class="catItemDateCreated">
			<?php echo JHTML::_('date', $this->item->created, "j.n.Y");?></span></b></div>
...
?>" style="width:<?php echo $this->item->imageWidth;?>px; height:auto;" />
 ...
 <!-- edited -->
	...
	<!-- Item "read more..." link -->
	<a class="catItemReadMore" href="<?php echo $this->item->link;?>">
			<b><?php echo JText::_('K2_READ_MORE');?></b>
		</a>
	<?php endif;?>
