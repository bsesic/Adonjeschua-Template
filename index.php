			...
			<div class="row">
				<div class="col-xs-3 col-sm-2 col-md-3 col-lg-3 hidden-xs">
					...
					<div class="col-md-15 hidden-xs"><div align="center hidden-xs">
						<?php
						$logo_url= $this->baseurl
						.'/templates/'
						.$this -> template
						.'/images/logo.gif';
						?>
						<img src="<?php	 echo $logo_url; ?>" id ="logo" alt="Logo" class="customImage img-responsive logo" width="<?php $imageinfo = getimagesize($logo_url); echo $imageinfo[0]; ?>" height="<?php echo $imageinfo[1]; ?>">
				</div>
				<!-- Left Side -->
